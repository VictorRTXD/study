...
function CheckoutSideMenu() {
    const {isOpenCheckoutSideMenu, closeCheckoutSideMenu, cartProducts, setCartProducts, order, setOrder, setCount, setSearchByTitle} = useContext(ShoppingCartContext);
